...
from sanjab.inputs import Raw, Clean, AutoQuery
        ...
        if self._load_all:
            ...
            for model, modelResults in models_doc_pks.iteritems():
                ...
                for doc_type, doc_pks in modelResults.iteritems():
                    ...
                    objects = model_index.read_queryset(using=self.query._using)
                    try:
