...
from sanjab.exceptions import NotHandled, SpatialError
...
class SearchResult(object):
    ...
    performance.
    """
    def __init__(self, app_label, model_name, pk, score, doc_type, **kwargs):
    ...
    def _get_log(self):
        return logging.getLogger('sanjab')
    ...
    def get_additional_fields(self):
        ...
        search engine, so it may have extra fields Sanjab's indexes aren't
        aware of.
        """
        additional_fields = {}
    ...
    def get_stored_fields(self):
        ...
        Useful for serializing results. Only returns the fields Sanjab's
