...
from sanjab.forms import ModelSearchForm, FacetedSearchForm
from sanjab.query import EmptySearchQuerySet


RESULTS_PER_PAGE = getattr(settings, 'SANJAB_SEARCH_RESULTS_PER_PAGE', 20)
