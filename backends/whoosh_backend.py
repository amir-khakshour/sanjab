...
from sanjab.backends import BaseEngine, BaseSearchBackend, BaseSearchQuery, log_query, EmptyResults
from sanjab.constants import ID, DJANGO_CT, DJANGO_ID
from sanjab.exceptions import MissingDependency, SearchBackendError
from sanjab.inputs import PythonData, Clean, Exact, Raw
from sanjab.models import SearchResult
from sanjab.utils import get_identifier
...
class WhooshSearchBackend(BaseSearchBackend):
    ...
    def setup(self):
        ...
        self.content_field_name, self.schema = self.get_schema(connections[self.connection_alias].get_unified_index().all_searchfields())
    ...
    def get_schema(self, fields):
        ...
        # Grab the number of keys that are hard-coded into Sanjab.
