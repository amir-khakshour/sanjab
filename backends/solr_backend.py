...
from sanjab.backends import BaseEngine, BaseSearchBackend, BaseSearchQuery, EmptyResults, log_query
from sanjab.constants import DJANGO_CT, DJANGO_ID, ID
...
class SolrSearchBackend(BaseSearchBackend):
    ...
    def extract_file_contents(self, file_obj):
        ...
        replaces the normal Sanjab indexing process with several unfortunate
        ...
        use it within Sanjab's normal templating process.
