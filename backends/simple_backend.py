...
from sanjab.backends import BaseEngine, BaseSearchBackend, BaseSearchQuery, log_query, SearchNode
from sanjab.inputs import PythonData
...
if settings.DEBUG:
    ...
    logger = logging.getLogger('sanjab.simple_backend')
