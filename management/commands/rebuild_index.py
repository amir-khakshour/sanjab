...
from sanjab.management.commands.clear_index import Command as ClearCommand
from sanjab.management.commands.update_index import Command as UpdateCommand
