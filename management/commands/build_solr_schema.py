...
from sanjab.backends.solr_backend import SolrSearchBackend
from sanjab import constants
...
class Command(BaseCommand):
    ...
    def build_context(self, using):
        ...
        content_field_name, fields = backend.get_schema(connections[using].get_unified_index().all_searchfields())
        return Context({
