...
from sanjab.exceptions import SearchFieldError
...
class SearchField(object):
    ...
    def __init__(self, model_attr=None, use_template=False, template_name=None,
                 ...
                 facet_class=None, boost=1.0, weight=0, analyzer=None, language=None):
...
class LocationField(SearchField):
    ...
    def convert(self, value):
        from sanjab.utils.geo import ensure_point, Point
...
class NestedField(SearchField):
    ...
    def __init__(self, **kwargs):
        ...
        if self.properties is None:
            raise SearchFieldError("'%s' fields require a custom properties mappings" % self.__class__.__name__)
